<?php 
     ...
     $sql_pesq = mysqli_query($conecta, "SELECT * FROM tblusuario WHERE email = '$email'") or die (mysql_error());
     ...
     <body>
          <div id="conteudo">
               ...
               <?php }
                    ...
                    $query = "UPDATE tblusuario SET senha = '$senhamd5' where id = ".$id_usuario;
